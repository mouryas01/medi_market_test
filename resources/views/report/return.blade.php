...
@endphp
        ...
        <div class="table-container">
            <section class="panel">
                ...
                <div class="panel-body">
                    <form class="form-inline" action="{{ route('returnReportFilterByDate') }}" method="post" autocomplete="off" id="myForm">
                        {{ csrf_field() }}
    ...
    <div class="row gutters">                       
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="table-container">
                <div class="t-header">Cancel Orders</div>
                    ...
                    <table id="copy-print-csv" class="table custom-table">
                        ...
                        @if(is_array($orders) && count($orders) > 0)   
                            ...
                            @foreach($orders as $key => $value) 
                                @if($value->order_status == 3)    {{-- 3 = Cancelled --}}                     
                                <tr>
                                    <td>{{ $sr }}</td>                                                                                                                           
                                    <td>
...
function resetForm(){
    ...
    location.href="{{ route('return-report') }}";
}
</script>
@endpush   
