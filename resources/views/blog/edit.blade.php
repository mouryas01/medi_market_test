                        ...
                        <div class="row gutters">
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                    ...
                                    <input id="title" type="text" class="form-control" name="title" value="{{ $blogs['title'] }}" required autofocus>
                                    @if ($errors->has('title'))
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                                    ...
                                    <textarea id="description" class="form-control" name="description" required>{{ $blogs['description'] }}</textarea>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="form-group{{ $errors->has('picture') ? ' has-error' : '' }}">
                                    ...
                                    <input type="hidden" name="old_picture" id="old_picture" class="form-control" value="{{ $blogs['image'] }}">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="form-group">                                    
                                    <img src="{{ url($blogs['image']) }}" id="uploaded_image" height="50px" width="50px">
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                    {{-- blank --}}
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-6">                                    
                                ...
                                <a href="{{ route('blogs.index') }}" class="btn btn-secondary" onclick="showloader()"> Cancel</a> 
                            </div>
                        </div>         
